...
public class activity_myroute extends FragmentActivity implements OnMapReadyCallback{

    private static String TAG = activity_myroute.class.getSimpleName();
    ...
    public List<String> getTussenstops(){
        ...
        }, error -> Toast.makeText(activity_myroute.this,"there was an error getting the waypoints",Toast.LENGTH_SHORT).show()){

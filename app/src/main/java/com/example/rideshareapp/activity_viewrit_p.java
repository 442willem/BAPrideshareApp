...
public class activity_viewrit_p extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonCancel = (Button)findViewById(R.id.button_cancel_req);
